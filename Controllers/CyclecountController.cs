...
namespace CycleCountSystem_CSS.Controllers
{
    public class CyclecountController : Controller
    {
        ...
        public ActionResult Create(CombineViewModel model, string Data_aktual, int id)
        {
            ...
            // Mengatur nilai IsCalculated berdasarkan hasil kalkulasi
            inventory.Calculate = (persentase == 100.00m); // Jika persentase 100, berarti sudah dihitung

            // Simpan perubahan ke database untuk IsCalculated
            db.SaveChanges();

            // Jika kalkulasi gagal, langsung panggil SubmitEmail
            if (persentase != 100.00m) // Perhatikan sufiks 'm' untuk menentukan literal desimal
            {
        ...
        public ActionResult DownloadPDF()
        {
            ...
            // Gunakan instance CombineViewModel sesuai kebutuhan Anda
            var data = viewModel; 
